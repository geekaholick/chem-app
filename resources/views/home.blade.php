...
<meta name="description" content="WebPanda is a Multi-purpose Responsive HTML5 Template created by yankeethems, powered by yankeeinfoweb and published
  on Themeforest.">
<meta name="author" content="yankeethemes">
<meta name="keywords" content="yankeethemes, yankeeinfoweb, webdesign, boostrap, wordpress, support, html, html5, css3, javascript, wordpress agency, support,
wordpress expert">
<meta name="contact" content="enquiry@yankeeinfoweb.com" />
<meta name="copyright" content="yankeethemes">
<!-- =================== /META EOC ==================== -->

<!-- =================== /TITLE EOC ==================== -->
<title>:: WebPanda - Multi-purpose Responsive HTML5 Template ::</title>
<!-- =================== /TITLE EOC ==================== -->
...
<link href="<?php echo url('/'); ?>/css/yit-plugins.css" rel="stylesheet" type="text/css">

<!-- /Style CSS (scafolding, strucrure & commonpages) -->
<link href="<?php echo url('/'); ?>/css/yit-style.css" rel="stylesheet" type="text/css">

<!-- /Boostrap Nav CSS (all navigation) -->
<link href="<?php echo url('/'); ?>/css/yit-bootstrap-nav.css" rel="stylesheet" type="text/css">

<!-- /Custom Nav CSS (all custom navigation) -->
<link href="<?php echo url('/'); ?>/css/yit-custom-nav.css" rel="stylesheet" type="text/css">

<!-- /Theme CSS (common theme element) -->
<link href="<?php echo url('/'); ?>/css/yit-theme.css" rel="stylesheet" type="text/css">

<!-- /Elements CSS (all general elements) -->
<link href="<?php echo url('/'); ?>/css/yit-elements.css" rel="stylesheet" type="text/css">

<!-- /Shortcode CSS (all shortcodes) -->
<link href="<?php echo url('/'); ?>/css/yit-shortcodes.css" rel="stylesheet" type="text/css">

<!-- /Blogs CSS (all blogs) -->
<link href="<?php echo url('/'); ?>/css/yit-blog.css" rel="stylesheet" type="text/css">

<!-- /Lawyer CSS -->
<link href="<?php echo url('/'); ?>/css/demo-categories/yit-lawyer.css" rel="stylesheet" type="text/css">

<!-- /Responsive CSS (media device css) -->
<link href="<?php echo url('/'); ?>/css/yit-responsive.css" rel="stylesheet" type="text/css">

<!-- =================== /WEB CSS EOC ==================== -->

<!-- ================ /GOOGLE FONT BOC =================== -->
<link href="https://fonts.googleapis.com/css?family=Montserrat:100,300,400,500,600,700,800,900" rel="stylesheet">
<link href="https://fonts.googleapis.com/css?family=Muli:200,300,400,400i,600,700,900" rel="stylesheet">
<!-- ================ /GOOGLE FONT EOC =================== -->
</head>

<body class="lawyer heading-muli">
...
<div class="page-wrapper">
  ...
  <header class="lawyer-header">
    ...
    <!-- /Navigation BOC -->
    <div class="yit-nav yit-nav-transparent-style yit-custom-nav-1">
      <nav class="navbar navbar-expand-md fixed-top navbar-light bg-none pt-20 pb-20 yit-on-scroll-nav yit-scroll-nav yit-bsnav-center-menu js-nav-active yit-custom-fade-full-menu">
    ...
    <!-- /Banner BOC -->
    <div class="yit-flexslider yit-slider-style-1 lawyer-banner" id="home">
  ...
  <!-- /About Section BOC -->
  <section id="about" class="lawyer-about pb-0" style="background-image:url(images/demo-categories/lawyer/grey_pattern.png);">
  ...
  <!-- /Practice Area Section BOC -->
  <section id="practice" class="lawyer-practice yit-pos-relative" style="background-image:url(images/demo-categories/lawyer/section-img-1.jpg);">
    <div class="line-divider-two hidden-xs"></div>
    <div class="container">
      <div class="row">
  ...
  <section id="blog" class="lawyer-blog yit-pos-relative yit-overflow light-grey-color-bg">
    ...
    <svg class="svg-curve arrow-left hidden-xs hidden-sm" xmlns="http://www.w3.org/2000/svg" fill="#fff" viewBox="0 0 12 20"><polygon points="0 0 0 16.7 0 23 9 8.42 2 0"/></svg>
    <div class="container">
      <div class="row">
        <div class="col">
  ...
  <footer class="webp-startup-footer footer-dark-style yit-footer-morden-alt-2" style="background-image:url(images/demo-categories/lawyer/dark_pattern.png);">
    <div class="yit-footer style-1">
     <div class="container">
      ...
      <!-- /Contact Block BOC -->
      <div class="yit-contact-box style-3 last-p-none xs-text-center">
        <div class="row">
  ...
  <!--/Go Top BOC -->
  <div class="back-top text-center"> <a Title="Go Top" class="img-border cream-color-bg" href="Javascript:void(0);" id="toTop"> <i class="fa fa-angle-double-up"></i> </a> </div>
  <!--/Go Top EOC -->
